            ...
            <tbody>
                <tr>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">238094 Views - 3 days</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">13:20</p></div>
                        <p class="vid-title">$10,000,000 SQUELCH BOX!!!</p>
                        <p class="vid-uploader">MegaBongo1999</p>
                        <p class="vid-stats">77732 Views - 1 day</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">41:00</p></div>
                        <p class="vid-title">Why I'm Leaving the SquelchTube Community...</p>
                        <p class="vid-uploader">SquelchGod</p>
                        <p class="vid-stats">1001876 Views - 5 days</p>
                    </td>
                </tr>
                <tr>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">288091 Views - 2 days</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">7:53</p></div>
                        <p class="vid-title">Gromlin Funny Moments Pt. 17</p>
                        <p class="vid-uploader">Best Top Clips in History</p>
                        <p class="vid-stats">1259 Views - 7 days</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">2:15</p></div>
                ...
                <tr>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">16:29</p></div>
                        <p class="vid-title">Why Virtual Dream is Dying</p>
                        <p class="vid-uploader">TedTech</p>
                        <p class="vid-stats">18240 Views - 1 day</p>
                    </td>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">2624 Views - 2 weeks</p>
                    </td>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">842342 Views - 3 days</p>
                    </td>
                </tr>
                <tr>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">25:33</p></div>
                        <p class="vid-title">I SQUELCHED MY HOUSE?</p>
                        <p class="vid-uploader">Squelch Or Die</p>
                        <p class="vid-stats">2910242 Views - 1 year</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">1:37:00</p></div>
                    ...
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">11:11</p></div>
                        <p class="vid-title">Virtual Dream Stronger than Ever?</p>
                        <p class="vid-uploader">TedTech</p>
                        <p class="vid-stats">89083 Views - 2 weeks</p>
                    </td>
                </tr>
                <tr>
                    <td class="vid-container">
                ...
                <tr>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">1439589 Views - 6 days</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">12:01</p></div>
                        <p class="vid-title">$15000 OR SQUELCH GUN!!!!!!!</p>
                        <p class="vid-uploader">KingSquelch</p>
                        <p class="vid-stats">2492935 Views - 3 weeks</p>
                    </td>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">128394 Views - 1 year</p>
                    </td>
                </tr>
                <tr>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">36:40</p></div>
                        <p class="vid-title">666Squelch999 - Z290b2hlbGw (Full EP)</p>
                        <p class="vid-uploader">Filth Den</p>
                        <p class="vid-stats">1409 Views - 6 days</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">10:21</p></div>
                        <p class="vid-title">BREAKING LEGS CHALLENGE!! $700 PRIZE</p>
                        <p class="vid-uploader">KingSquelch</p>
                        <p class="vid-stats">9043299 Views - 2 days</p>
                    </td>
                    <td class="vid-container">
                ...
                <tr>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">36:40</p></div>
                        <p class="vid-title">GONE 2 JAIL (FUNDRAISER)</p>
                        <p class="vid-uploader">KingSquelch</p>
                        <p class="vid-stats">193239 Views - 1 days</p>
                    </td>
                    <td class="vid-container">
                        ...
                        <p class="vid-stats">84392 Views - 3 weeks</p>
                    </td>
                    <td class="vid-container">
                        <div class="vid-thumb"><p class="vid-time">0:07</p></div>
